	...
	<div class="card">
		...
		<form action="?page=clientSave" method="POST">
			...
			<div class="form-group">
				...
				<input type="text" name="nm_cliente" value="<?php print $row['nm_cliente']; ?>" class="form-control">
				<label><b>CPF/CNPJ</b></label>
				<input type="text" name="cpf_cnpj" value="<?php print $row['cpf_cnpj']; ?>" onkeypress='mascaraMutuario(this,cpfCnpj)' maxlength="18" class="form-control">
				<label><b>Região</b></label>
				<input type="text" name="nm_regiao" value="<?php print $row['nm_regiao']; ?>" class="form-control">
			</div>
			<button 
				id='button'
				type="submit" 
